...
export const config = {
  ...
  baseUrl: `https://trade-imports-gmr-journey-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `trade-imports-gmr-journey-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `trade-imports-gmr-journey-tests-${process.env.ENVIRONMENT}`
        },
